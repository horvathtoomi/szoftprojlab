...
public class SmallTecton extends Tecton implements TectonAccept {
     ...
     */
    public SmallTecton(String name, int maxStrings) {
     ...
     * @return Egy tömb, amely két új SmallTecton példányt tartalmaz.
     */
	@Override
    public Tecton[] createSplitTectons(String newName1, String newName2) {
        Tecton t1 = new SmallTecton(newName1, getMaxStrings());
        Tecton t2 = new SmallTecton(newName2, getMaxStrings());
